...
Avoid restating routine safety boundaries that the target model already handles reliably. Focus on task-specific requirements that need explicit guidance.
